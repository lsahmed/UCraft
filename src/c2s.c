...
void (*c2s_play_1_21_5[])(player_t *currentPlayer) = {
    ...
    &PlayC2S_set_test_block,                // 0x39
    &PlayC2S_sign_update,                   // 0x3A
    &PlayC2S_swing,                         // 0x3B
    &PlayC2S_teleport_to_entity,            // 0x3C
    &PlayC2S_test_instance_block_action,    // 0x3D
    &PlayC2S_use_item_on,                   // 0x3E
    &PlayC2S_use_item                       // 0x3F
};
