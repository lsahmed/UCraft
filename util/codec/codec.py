...
dimension_type.tags.append(TAG_String(
    name="type", value="dimension_type"))
...
dimension_attr.tags.append(
    TAG_Int(name="monster_spawn_block_light_limit", value=15))
...
dimension_attr.tags.append(TAG_String(
    name="infiniburn", value="#infiniburn_overworld"))
...
plains_attr_effects_mood.tags.append(TAG_String(
    name="sound", value="ambient.cave"))
plains_attr_effects_mood.tags.append(
    TAG_Int(name="block_search_extent", value=8))
...
for x in range(len(damage_types)):
    ...
    damage_type_element.tags.append(TAG_String(
        name="scaling", value="never"))
    damage_type_element.tags.append(
    TAG_Float(name="exhaustion", value=0))
...
chat_element_chat.tags.append(TAG_String(
    name="translation_key", value="chat.type.text"))
narration_element_chat.tags.append(TAG_String(
    name="translation_key", value="chat.type.text.narrate"))
chat_element_chat_decoration_parameters = TAG_List(
    name="parameters", type=TAG_String)
chat_element_chat_decoration_parameters.tags.append(TAG_String(value="sender"))
chat_element_chat_decoration_parameters.tags.append(
    TAG_String(value="content"))
